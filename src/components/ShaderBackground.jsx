// ShaderBackground — a single WebGL canvas that fills its parent with an
// animated color-mesh ("mesh drift"). Zero dependencies.
// <div style={{ position: 'relative' }}><ShaderBackground style={{ position: 'absolute', inset: 0 }} />…
...
// "Mesh drift" preset, recolored to the app's brand palette (navy -> blue -> white).
const UNIFORMS = {
  colors: [
    [0.008, 0.008, 0.02],
    [0.098, 0.0, 1.0],
...
export function ShaderBackground({ style, className }) {
