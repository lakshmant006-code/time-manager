...
function Nav() {
  ...
  return (
    <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '24px 48px', position: 'relative', zIndex: 2 }}>
...
function Hero() {
  const navigate = useNavigate();
  return (
    <div style={{ textAlign: 'center', padding: '56px 24px 0', position: 'relative', zIndex: 2 }}>
      ...
      <h1 style={{ fontFamily: 'var(--font-sans)', fontSize: 52, lineHeight: 'var(--leading-tight)', color: 'var(--brand-navy)', margin: '0 auto 20px', maxWidth: 760, letterSpacing: 'var(--tracking-tight)', fontWeight: 'var(--font-bold)' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: 14, marginBottom: 64 }}>
...
function StatCard({ label, value, accent }) {
  return (
    <div style={{ flex: 1, background: accent, borderRadius: 'var(--radius-lg)', padding: '14px 18px' }}>
...
function StatsBar() {
  ...
  return (
    <div style={{ maxWidth: 1040, margin: '64px auto', background: 'var(--brand-blue)', borderRadius: 'var(--radius-xl)', display: 'flex', padding: '28px 40px', gap: 40, position: 'relative', zIndex: 2 }}>
      {stats.map((s) => (
  ...
  return (
    <div style={{ maxWidth: 1040, margin: '0 auto 80px', padding: '0 24px', position: 'relative', zIndex: 2 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 16 }}>
        {STEPS.map((s) => (
          <div key={s.n} style={{ background: 'var(--white)', border: '1px solid var(--border-default)', borderRadius: 'var(--radius-lg)', padding: 24 }}>
...
function FeatureCard({ title, desc, large }) {
  return (
    <div style={{ flex: 1, background: large ? 'var(--brand-navy)' : 'var(--white)', border: large ? 'none' : '1px solid var(--border-default)', borderRadius: 'var(--radius-lg)', padding: 24, minHeight: large ? 220 : 160, display: 'flex', flexDirection: 'column', justifyContent: 'flex-end' }}>
...
function CrossTeamSection() {
  ...
  return (
    <div style={{ maxWidth: 1040, margin: '0 auto 80px', padding: '0 24px', position: 'relative', zIndex: 2 }}>
      <div style={{ background: 'var(--surface-subtle)', borderRadius: 'var(--radius-xl)', padding: '40px 32px', display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 32 }}>
        {items.map((it) => (
          <div key={it.title}>
