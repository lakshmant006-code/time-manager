    ...
    <AppShell>
      <div style={{ background: '#fff', borderRadius: 8, padding: 32, boxShadow: 'var(--shadow-lg)', fontFamily: 'var(--font-sans)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 4 }}>
          <div>
            <h2 style={{ fontSize: 24, fontWeight: 600, fontFamily: 'var(--font-display)', margin: 0 }}>Add Client</h2>
            <p style={{ color: 'var(--text-secondary)', marginTop: 4 }}>Organization ID: #1</p>
          </div>
          <Badge>Admin Only</Badge>
        </div>
        <p style={{ color: 'var(--text-secondary)', marginBottom: 24 }}>Add a new client manually, or bring over a whole client base at once</p>
        <Tabs
