  ...
  return (
    <EmployeeShell>
      <div style={{ background: '#fff', borderRadius: 8, padding: 32, boxShadow: 'var(--shadow-lg)', fontFamily: 'var(--font-sans)' }}>
        <h2 style={{ fontSize: 24, fontWeight: 600, fontFamily: 'var(--font-display)', margin: '0 0 4px' }}>Skills</h2>
        <p style={{ color: 'var(--text-secondary)', margin: '0 0 24px' }}>Track the skills and certifications on your profile</p>
